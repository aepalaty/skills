...
>
> **Workflow caching tip:** I added `cache: pip` to the `setup-python` step in each workflow to speed up repeated local runs with `act`. Shaved off a good 30–40 seconds per run on my machine.
